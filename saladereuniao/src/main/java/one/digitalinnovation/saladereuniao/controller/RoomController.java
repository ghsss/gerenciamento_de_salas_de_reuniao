...
import one.digitalinnovation.saladereuniao.exception.ResourcesNotFoundException;
import one.digitalinnovation.saladereuniao.model.*;
...
public class RoomController {
    ...
    public ResponseEntity<Room> updateRoom(@PathVariable (value = "id") Long roomId,
                                           @Valid @RequestBody Room roomDetails ) throws ResourcesNotFoundException{
        Room room = roomRepository.findById(roomId)
